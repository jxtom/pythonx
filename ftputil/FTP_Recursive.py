...
if __name__ == '__main__':
    ...
    logstr = datenow
    # 配置如下变量
    hostaddr = '192.168.40.198'  # ftp地址
    username = 'anonymous'  # 用户名
    password = 'anonymous'  # 密码
    port = 21  # 端口号
    rootdir_remote = '/181'  # 远程目录
    rootdir_local = '.' + os.sep + 'bak/' + rootdir_remote  # 本地目录

    ftpclient = MYFTP(hostaddr, username, password, rootdir_remote, port)
    ftpclient.login()
    ftpclient.download_files(rootdir_local, rootdir_remote)
